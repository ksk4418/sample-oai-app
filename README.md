...
|UI_TITLE|Advantage| Chat title (left-top) and page title (HTML)
|UI_LOGO|| Logo (left-top). Defaults to Advantage logo. Configure the URL to your logo image to modify.
|UI_CHAT_LOGO|| Logo (chat window). Defaults to Advantage logo. Configure the URL to your logo image to modify.
...
|UI_FAVICON|| Defaults to Advantage favicon. Configure the URL to your favicon to modify.
